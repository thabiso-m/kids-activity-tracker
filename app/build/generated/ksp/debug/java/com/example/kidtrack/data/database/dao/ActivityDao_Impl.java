  ...
  public ActivityDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfActivity = new EntityInsertionAdapter<Activity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `activities` (`id`,`category`,`description`,`notes`,`date`,`time`,`profileId`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public Activity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Activity(_tmpId,_tmpCategory,_tmpDescription,_tmpNotes,_tmpDate,_tmpTime,_tmpProfileId);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<Activity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpProfileId;
            _tmpProfileId = _cursor.getLong(_cursorIndexOfProfileId);
            _item = new Activity(_tmpId,_tmpCategory,_tmpDescription,_tmpNotes,_tmpDate,_tmpTime,_tmpProfileId);
            _result.add(_item);
          }
          return _result;
        } finally {
