  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `activities` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `category` TEXT NOT NULL, `description` TEXT NOT NULL, `notes` TEXT NOT NULL, `date` TEXT NOT NULL, `time` TEXT NOT NULL, `profileId` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `reminders` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `time` TEXT NOT NULL, `frequency` TEXT NOT NULL, `associatedActivityId` INTEGER NOT NULL, `profileId` INTEGER NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e9669b7fb24dc0d8c4c1b03ab90d3f9f')");
      }
    ...
    }, "e9669b7fb24dc0d8c4c1b03ab90d3f9f", "3174b81cc2dedaa74d8622b07bdbc31c");
